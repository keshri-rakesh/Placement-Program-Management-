    ...
    <script>
        ...
        <style>
         ...
         <center style="padding-top: 2%;">
            ...
            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Company..." title="Type in a name" style="width: 70%;"><br><br>
            <%
            Read_ValuesCompany obj_Read_Values=new Read_ValuesCompany();
            ...
            <table border="2" class="css-serial" id="myTable">
                <tr>
                    <th>Sr. No</th><th>Company Name</th><th>Language</th><th>Job Type</th><th>Location</th><th>Status</th><th>Date</th><th>Edit</th><th>Delete</th>
                </tr>
            <%
            ...
            %>
                        <tr>	
                                ...
                                <td><%=obj_User_Bean.getstatus() %></td>
                                <td><%=obj_User_Bean.getupcoming_date() %></td>	
                                
                                <td>
                                <a href="editCompany.jsp?company_id=<%=obj_User_Bean.getcompany_id()%>">Edit</a>
                                </td>
                                <td>
                                <a href="delete_controllerCompany.jsp?company_id=<%=obj_User_Bean.getcompany_id()%>">Delete</a>
                                </td>	  
                        </tr>
            <%	 
            }
            ...
            <br><a href="insert_valuesCompany.jsp" class="get-started-btn">Add Company</a><br><br>
        </center>
    <!--<center style="padding-top: 2%;">
        <h1>Company Details</h1> <br>
        <%!
