...
@WebServlet(name = "UploadServletStudentResume", urlPatterns = {"/UploadServletStudentResume"})
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 100, // 100 MB
        maxFileSize = 1024 * 1024 * 1000, // 1 GB
        maxRequestSize = 1024 * 1024 * 1000)   	// 1 GB
public class UploadServletStudentResume extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                String sql = "insert into uploadresume(filename,path,add_date) values(?,?,?)";
                ...
                if (status > 0) {
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("/UploadResumeStudent.jsp");
