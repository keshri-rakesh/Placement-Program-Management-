<%@page import="Model.Company.EditValuesDaoCompanySchedule"%>
...
<header id="header" class="fixed-top">
  ...
  <center>
	<br><br><br><br>
	<h1>Schedule Company Meet</h1>
	<%
		String company_id=(String)request.getParameter("company_id");
		
		EditValuesDaoCompanySchedule obj_Edit_values=new EditValuesDaoCompanySchedule();
	...
	<form action="edit_controllerCompanySchedule.jsp">
		<center>
		...
		<tr><td style="text-align: right;">Job Type:</td><td style="text-align: left;"><input type="text" name="job_type" value="<%=obj_User_Bean.getjob_type()%>" readonly>
		...
		<tr><td style="text-align: right;">Date:</td><td style="text-align: left;"><input type="text" id="datepicker" name="upcoming_date" value="<%=obj_User_Bean.getupcoming_date()%>"></td>
			<tr><td style="text-align: right;">Time Slot:</td><td style="text-align: left;"><select name="time_slot">
				<option value="11:00">11:00</option>
				<option value="14:00">14:00</option></select> </td></tr>
</table> 
	<br><input type="submit" value="Schedule" class="get-started-btn" onclick="schedulemeet()"> 
	<a href="http://localhost:8080/ppm/ViewScheduleFaculty.jsp" class="get-started-btn">Cancel</a>
	</form>
