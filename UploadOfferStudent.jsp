...
<body>
  ...
  <!-- Register Form -->
<form name="form" action="UploadServletStudentOffer" method="post" enctype="multipart/form-data" class="box" style="width: 50%;">
    <h1 style="text-transform: capitalize;">Upload Signed Offer Letter</h1></br>
