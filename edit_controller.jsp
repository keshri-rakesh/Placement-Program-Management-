...
<%
    ...
    String placement_status=request.getParameter("placement_status");
    String company_name=request.getParameter("company_name");


    StudentBean obj_User_Bean=new StudentBean();
    obj_User_Bean.setprn(prn);
	obj_User_Bean.setstudentName(student_name);
    obj_User_Bean.setplacementStatus(placement_status);
	obj_User_Bean.setclass(std_class);
    obj_User_Bean.setcompany(company_name);
...
<script type="text/javascript">
 ...
 window.location.href="http://localhost:8080/ppm/ViewPlacementFaculty.jsp"
</script>
