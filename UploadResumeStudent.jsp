...
<body>
  ...
  <!-- Register Form -->
<form name="form" action="UploadServletStudentResume" method="post" enctype="multipart/form-data" class="box" style="width: 50%;">
    <h1 style="text-transform: capitalize;">Upload Resume</h1></br>
