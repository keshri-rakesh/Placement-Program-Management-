<%@page import="Model.Company.Insert_ValuesCompany"%>
...
<%
    ...
    Insert_ValuesCompany obj_Insert_Values=new Insert_ValuesCompany();

    obj_Insert_Values.insert_values(company_id, company_name, language, job_type, location, status, upcoming_date);
