...
<table border="2">
<form action="insert_controller.jsp">

<tr><td style="text-align: right;">PRN:</td><td style="text-align: left;"><input type="text" name="prn"></td></tr>
		<tr><td style="text-align: right;">Student Name:</td><td style="text-align: left;"><input type="text" name="student_name"></td></tr>
	    <tr><td style="text-align: right;">Class:</td><td style="text-align: left;"><select name="std_class">
			<option value="MCA3">MCA3</option>
			<option value="MCA5">MCA5</option>
			<option value="MSC AIML">MSC AIML</option>
			<option value="PGDCA">PGDCA</option></select> </td></tr>
		<tr><td style="text-align: right;">Placement Status:</td><td style="text-align: left;"><select name="placement_status">
			<option value="placed">placed</option>
			<option value="pending">pending</option></select> </td></tr>
		<tr><td style="text-align: right;">Company:</td><td style="text-align: left;"><input type="text" name="company_name"></td></tr>
	</table>
