<%@page import="Model.Company.Delete_valuesSchedule"%>
...
<%
    ...
    Delete_valuesSchedule obj_Delete_values=new Delete_valuesSchedule();
...
<script type="text/javascript">
 ...
 window.location.href="http://localhost:8080/ppm/faculty_home.jsp"
</script>
